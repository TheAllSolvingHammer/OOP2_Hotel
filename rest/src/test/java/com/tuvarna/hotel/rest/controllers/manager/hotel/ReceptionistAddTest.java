...
class ReceptionistAddTest extends ApplicationTest {
    private ReceptionistAdd controller;

    @Override
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/tuvarna/hotel/rest/manager/add-receptionist.fxml"));
