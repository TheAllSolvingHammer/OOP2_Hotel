...
class QueryReservationsOwnerTest extends ApplicationTest {
    private QueryReservationsOwner controller;
    private List<Reservation> reservations;
    @Override
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/tuvarna/hotel/rest/owner/query-reservations.fxml"));
