...
class DisplayHotelInfoTest extends ApplicationTest {
    private DisplayHotelInfo controller;
    @Override
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/tuvarna/hotel/rest/reception/hotel-scene.fxml"));
