...
class AssignedEmployeeHotelsTest extends ApplicationTest {
    private AssignedEmployeeHotels controller;
    @Override
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/tuvarna/hotel/rest/reception/hotel-receptionist.fxml"));
