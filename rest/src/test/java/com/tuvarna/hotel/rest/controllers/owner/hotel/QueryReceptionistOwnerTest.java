...
class QueryReceptionistOwnerTest extends ApplicationTest {
    private QueryReceptionistOwner controller;
    @Override
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/tuvarna/hotel/rest/owner/query-hotel-receptionist.fxml"));
