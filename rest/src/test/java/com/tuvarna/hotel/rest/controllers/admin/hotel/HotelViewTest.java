...
class HotelViewTest extends ApplicationTest {
    private HotelView controller;

    @Override
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/tuvarna/hotel/rest/admin/hotels-scene.fxml"));
