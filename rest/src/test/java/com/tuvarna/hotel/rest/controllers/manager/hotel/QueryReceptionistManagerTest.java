...
class QueryReceptionistManagerTest extends ApplicationTest {
    private QueryReceptionist controller;
    @Override
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/tuvarna/hotel/rest/manager/query-hotel-receptionist.fxml"));
