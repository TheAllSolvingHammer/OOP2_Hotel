...
class ManagerHotelViewTest extends ApplicationTest {
    private ManagerHotelView controller;
    @Override
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/tuvarna/hotel/rest/manager/show-all-hotels.fxml"));
