...
public class InputQueryPasswordExceptionCase {
    public static ErrorProcessor handleThrowable(Throwable throwable) {
        ...
        return API.Match(throwable).of(
                Case($(instanceOf(QueryException.class)), e -> ErrorProcessor.builder()
                        .message(e.getMessage())
                        .build()),
                Case($(instanceOf(InputException.class)), e -> ErrorProcessor.builder()
                        .message(e.getMessage())
                        .build()),
                Case($(instanceOf(PasswordException.class)), e -> ErrorProcessor.builder()
                        .message(e.getMessage())
                        .build()),
                Case($(instanceOf(RuntimeException.class)), e -> ErrorProcessor.builder()
                        .message(e.getMessage())
                        .build())
